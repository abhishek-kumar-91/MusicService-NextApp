...
function HeroSection() {
  return (
    <div 
    className='text-white h-auto 2xl:h-[100vh] md:h-[40ren] w-full rounded-md flex
  flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0'>
     <Spotlight
      ...
      <h1
      className='mt-20  md:mt-56 2xl:mt-28 text-4xl md:text-7xl
      ...
      >Dive into our comprehensive music courses and transform
        your musical journey today. Whether you're a beginner or looking
